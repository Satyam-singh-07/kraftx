    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.orders.index') }}" class="text-blue-600 hover:text-blue-700 font-medium text-sm">View all orders</a>
            </div>
            ...
            <x-admin.table :headers="['Order ID', 'Customer', 'Amount', 'Status', 'Date', 'Action']">
                @foreach($stats['recent_orders'] as $order)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.orders.show', $order['db_id']) }}" class="text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
