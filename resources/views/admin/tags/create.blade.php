<x-layouts.admin>
    <div class="max-w-2xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-800 dark:text-white">Create Tag</h2>
            ...
            <x-admin.card title="Tag Details">
                <div class="space-y-4 mt-4">
                    <div>
                        ...
                        <input type="text" name="name" required value="{{ old('name') }}" placeholder="Tag name"
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" value="{{ old('slug') }}" placeholder="tag-slug"
