        ...
        <form action="{{ route('admin.customers.store') }}" method="POST" class="space-y-6">
            ...
            <x-admin.card title="Account Information">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Password <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Confirm Password <span class="text-red-500">*</span></label>
                ...
                <div class="space-y-5 mt-4">
                    <div>
                        ...
                        <textarea name="address" rows="3" placeholder="Enter primary shipping address..."
                                  class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">{{ old('address') }}</textarea>
                    </div>
