    ...
    >
        <div class="lg:col-span-3 space-y-6">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-gray-800 dark:text-white">Create Blog Post</h2>
                <a href="{{ route('admin.blog-posts.index') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400">Back to List</a>
            </div>

            <form action="{{ route('admin.blog-posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="postForm">
                @csrf
                ...
                <x-admin.card title="Post Content">
                    <div class="space-y-5 mt-4">
                        <div>
                            ...
                            <input type="text" name="title" required value="{{ old('title') }}" placeholder="Post title"
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" value="{{ old('slug') }}" placeholder="post-slug"
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" rows="2" placeholder="Brief summary of the post..."
                                class="block w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white outline-none">{{ old('excerpt') }}</textarea>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        ...
                        <div class="space-y-4 pt-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_home" id="is_home" value="1" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                ...
                productList.innerHTML = products.map(p => `
                    <div class="flex items-center gap-3 p-2 border rounded-lg bg-gray-50 dark:bg-gray-700/50">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-xs font-medium truncate dark:text-white">${p.name}</p>
