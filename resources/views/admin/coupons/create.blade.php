<x-layouts.admin>
    <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-800 dark:text-white">Create Coupon</h2>
            ...
            <x-admin.card title="Coupon Details">
                <div class="space-y-5 mt-4">
                    <div>
                        ...
                        <div class="flex">
                            <input type="text" name="code" id="coupon_code" required value="{{ old('code') }}" placeholder="e.g. SUMMER50"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="discount_value" required value="{{ old('discount_value') }}" placeholder="e.g. 15"
                                   class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
            ...
            <x-admin.card title="Usage Restrictions">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <input type="number" step="0.01" name="min_cart_value" value="{{ old('min_cart_value', 0) }}"
                               class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                    ...
                    <div>
                        ...
                        <input type="number" name="usage_limit" value="{{ old('usage_limit') }}" placeholder="e.g. 100"
                               class="block w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none">
                        <p class="text-[10px] text-gray-500 mt-1">Total times this coupon can be used across the store.</p>
                    </div>
                </div>
            </x-admin.card>
