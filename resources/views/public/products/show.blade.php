                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <x-product-card :product="[
                                ...
                                'sizes' => $related->variants->whereNotNull('size')->unique('size')->pluck('size')->values()->all(),
                                'colors' => $related->variants->whereNotNull('color')->unique('color')->map(fn($v) => ['name' => $v->color, 'image' => $related->images->first() ? $related->images->first()->thumb_url : '', 'class' => '']),
                                'badges' => [],
