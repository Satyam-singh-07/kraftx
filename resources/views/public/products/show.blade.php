<x-layout>
                            ...
                            <div class="product-thumbs-slider style-row row_left">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started"
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide" data-color="green" data-size="L">
                                                <a href="assets/images/product/single/detail-1.jpg" target="_blank"
                                            ...
                                            <div class="swiper-slide" data-color="green" data-size="S">
                                                <div class="video-product">
                                                    <video class="" playsinline="" autoplay="" preload="metadata"
                                                        muted="" controls="" loop=""
                                                        src="assets/images/video/video-product.mp4"></video>
                                                </div>
                                            </div>
                                            <!-- item 3 -->
                                ...
                                <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom"
                                    ...
                                    <div class="swiper-wrapper stagger-wrap">
                                        ...
                                        <!-- item 2 -->
                                        <div class="swiper-slide stagger-item">
                                            <div class="item tf-btn-video btn-abs">
                                                <img loading="lazy" width="82" height="110"
                        ...
                        <div class="tf-product-info-wrap position-relative mt-md-0">
                            ...
                            <div class="tf-product-info-list other-image-zoom">
                                ...
                                <div class="tf-product-variant">
                                    ...
                                    <div class="variant-picker-item variant-size">
                                        <div class="variant-picker-label">
                                            ...
                                            <a href="product-video.html#findSize" data-bs-toggle="modal"
                                ...
                                <div class="tf-product-extra-link">
                                    <a href="product-video.html#compare" data-bs-toggle="offcanvas"
                                        class="product-extra-icon link">
                                        <i class="icon icon-ArrowsLeftRight"></i>
                                        Compare
                                    </a>
                                    <a href="product-video.html#ask" data-bs-toggle="modal"
                                        class="product-extra-icon link">
                                    ...
                                    <a href="product-video.html#share" data-bs-toggle="modal"
                                        class="product-extra-icon link">
            ...
            <div class="container">
                <ul class="tab-btn-wrap-v1" role="tablist">
                    <li class="nav-tab-item" role="presentation">
                        <a href="product-video.html#description" data-bs-toggle="tab" class="tf-btn-tab active"
                            role="tab">
                            <span class="h5 fw-medium">Description</span>
                        </a>
                    </li>
                    <li class="nav-tab-item" role="presentation">
                        <a href="product-video.html#customer-reviews" data-bs-toggle="tab" class="tf-btn-tab"
                            role="tab">
                            <span class="h5 fw-medium">Customer Reviews</span>
                        </a>
                    </li>
                    <li class="nav-tab-item" role="presentation">
                        <a href="product-video.html#shipping-returns" data-bs-toggle="tab" class="tf-btn-tab"
                            role="tab">
                            <span class="h5 fw-medium">Shipping & Returns</span>
                        </a>
                    </li>
                    <li class="nav-tab-item" role="presentation">
                        <a href="product-video.html#return-policies" data-bs-toggle="tab" class="tf-btn-tab" role="tab">
                    ...
                    <div class="tab-pane" id="customer-reviews" role="tabpanel">
                        <div class="product-desc_review">
                            <div class="box-rating">
                                ...
                                <a href="product-video.html#" class="action tf-btn animate-btn">
                                    Write a review
                                </a>
                            </div>
                                    ...
                                    <div class="comment-list">
                                        <div class="box-comment">
                                            ...
                                            <p class="comment_text text-body-1">
                                                ...
                                                sleek
                                                the pieces feel. The non-stick ceramic surface is excellent, and
                                                it’s
                                                easy to clean.
                                            </p>
                                        ...
                                        <div class="box-comment">
                                            ...
                                            <p class="comment_text text-body-1">
                                                Great experience overall! Easy checkout process, fast shipping, and
                                                the
                                        ...
                                        <div class="tf-grid-layout md-col-2">
                                            <div class="tf-grid-layout">
                                                <fieldset class="tf-field">
                                                    <label for="review" class="tf-lable fw-medium">Review
                                                        Title</label>
                                                ...
                                                <fieldset class="tf-field">
                                                    <label for="name" class="tf-lable fw-medium">Your Name <span
                                                            class="text-primary">*</span></label>
                                                    <input type="text" id="name" placeholder="You Name (Public)"
                                                        required="">
                                                </fieldset>
                                            </div>
                                            <fieldset class="tf-field d-flex flex-column">
                                                ...
                                                <textarea name="message" id="message"
                                                    placeholder="Write your comment here" class="h-md-100"></textarea>
                                            </fieldset>
                                        </div>
                    ...
                    <div class="tab-pane" id="return-policies" role="tabpanel">
                        <div class="tab-content_desc desc-3 d-grid">
                            ...
                            <div class="box-desc">
                                <h5 class="desc_title">Return Policies</h5>
                                <ul class="list">
                                    <li class="cl-text-2">- Exchange your item for a different size, color, or
                                        style, or
        ...
        <div class="flat-spacing flat-animate-tab pt-0">
            <div class="container">
                <ul class="tab-btn-wrap-v1 style-2 justify-content-sm-center" role="tablist">
                    <li class="nav-tab-item" role="presentation">
                        <a href="product-video.html#related" data-bs-toggle="tab" class="tf-btn-tab active" role="tab">
                            <span class="h4 fw-medium">Related Products</span>
                        </a>
                    </li>
                    <li class="nav-tab-item" role="presentation">
                        <a href="product-video.html#recently" data-bs-toggle="tab" class="tf-btn-tab" role="tab">
                                    ...
                                    <div class="card-product">
                                        <div class="card-product_wrapper">
                                            ...
                                            <ul class="product-action_list">
                                                ...
                                                <li>
                                                    <a href="product-video.html#quickView" data-bs-toggle="offcanvas"
                                                        class="hover-tooltip tooltip-left box-icon">
                                            ...
                                            <div class="product-action_bot">
                                                <a href="product-video.html#quickAdd" data-bs-toggle="modal"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="footer-infor d-flex flex-column align-items-start mb-lg-0">
                                <a href="index.html" class="logo-site mb-16">
                                ...
                                <a href="https://www.google.com/maps?q=600+N+Michigan+Ave+Chicago,+IL+60611+USA"
                                    target="_blank" class="text-decoration-underline text-primary lh-26 mb-16">
                                    Open in Maps
                                </a>
                                <a href="mailto:hi.amere@gmail.com" class="cl-text-2 link mb-8">
                                    hi.amere@gmail.com
                                </a>
                                <a href="tel:3156666688" class="cl-text-2 link mb-16">
                                    315-666-6688
                                </a>
                            ...
                            <div class="footer-col-block footer-wrap-2 mx-xl-auto">
                                ...
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        ...
                                        <li><a href="return-and-refund.html" class="cl-text-2 link">Return &
                                                Refund</a>
                                        </li>
                                        <li><a href="privacy-policy.html" class="cl-text-2 link">Privacy Policy</a>
                                        </li>
                            ...
                            <div class="footer-col-block footer-wrap-3 mb-0">
                                ...
                                <div class="tf-collapse-content">
                                    ...
                                    <p class="text-remember cl-text-2">
                                        ...
                                        and
                                        <a href="privacy-policy.html" class="text-main link link-underline">
                                            Privacy Policy
                                        </a>.
                                    </p>
                                </div>
    ...
    <div class="tf-toolbar-bottom">
        ...
        <div class="toolbar-item">
            <a href="product-video.html#search" data-bs-toggle="modal">
                <span class="toolbar-icon">
                    <i class="icon icon-MagnifyingGlass"></i>
                </span>
                    ...
                    <form class="form-log">
                        ...
                        <div class="group-action">
                            ...
                            <p class="orther-log text-center">
                                ...
                                <a href="product-video.html#sign" data-bs-toggle="modal"
                        ...
                        <div class="tf-compare-offcanvas list-empty">
                            ...
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
                                    ...
                                    <img class="radius-3" width="660" height="880"
                                        src="assets/images/product/product-2.jpg" alt="Image">
                                </a>
                            </div>
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
        ...
        <div class="mini-quick-image">
            <div class="wrap-quick wrapper-scroll-quickview">
                <div class="image item-scroll-quickview" data-scroll-quickview="Green">
                    <img loading="lazy" width="340" height="444" src="assets/images/product/single/detail-1.jpg"
                        alt="Image">
                </div>
                <div class="image item-scroll-quickview" data-scroll-quickview="Green">
                    <img loading="lazy" width="340" height="444" src="assets/images/product/single/detail-1_2.jpg"
                        alt="Image">
                </div>
                <div class="image item-scroll-quickview" data-scroll-quickview="Green">
                    <img loading="lazy" width="340" height="444" src="assets/images/product/single/detail-1_3.jpg"
                        alt="Image">
                </div>
                <div class="image item-scroll-quickview" data-scroll-quickview="Gray">
                    <img loading="lazy" width="340" height="444" src="assets/images/product/single/detail-1_5.jpg"
                        alt="Image">
                </div>
                <div class="image item-scroll-quickview" data-scroll-quickview="Gray">
                    <img loading="lazy" width="340" height="444" src="assets/images/product/single/detail-1_6.jpg"
                        alt="Image">
                </div>
                <div class="image item-scroll-quickview" data-scroll-quickview="Black">
                    <img loading="lazy" width="340" height="444" src="assets/images/product/single/detail-1_7.jpg"
                        alt="Image">
                </div>
                <div class="image item-scroll-quickview" data-scroll-quickview="Black">
                    <img loading="lazy" width="340" height="444" src="assets/images/product/single/detail-1_8.jpg"
                        alt="Image">
                </div>
            </div>
        </div>
                            ...
                            <div class="variant-picker-values">
                                ...
                                <label
                                    ...
                                    <span class="img">
                                        <img loading="lazy" width="60" height="60"
                                            src="assets/images/product/single/img_square/detail-1_2.jpg"
                                            data-src="assets/images/product/single/img_square/detail-1_2.jpg" alt="img">
                                    </span>
                                    <span class="tooltip">Green</span>
                                </label>
                                ...
                                <label
                                    ...
                                    <span class="img">
                                        <img loading="lazy" width="60" height="60"
                                            src="assets/images/product/single/img_square/detail-1_5.jpg"
                                            data-src="assets/images/product/single/img_square/detail-1_5.jpg" alt="img">
                                    </span>
                                    <span class="tooltip">Gray</span>
                                </label>
                                ...
                                <label
                                    ...
                                    <span class="img">
                                        <img loading="lazy" width="60" height="60"
                                            src="assets/images/product/single/img_square/detail-1_7.jpg"
                                            data-src="assets/images/product/single/img_square/detail-1_7.jpg" alt="img">
                                    </span>
                                    <span class="tooltip">Black</span>
                                </label>
                            </div>
            ...
            <div class="wrap-recommendations">
                <div class="list-cart">
                    <div class="list-cart-item">
                        <a href="product-video.html#" class="image">
                            <img loading="lazy" width="212" height="283" src="assets/images/product/product-4.jpg"
                                alt="Image">
                        </a>
                        <div class="content">
                    ...
                    <div class="list-cart-item">
                        <a href="product-video.html#" class="image">
                            <img loading="lazy" width="212" height="283" src="assets/images/product/product-3.jpg"
                                alt="Image">
                        </a>
                        <div class="content">
                            <a class="name fw-medium link text-line-clamp-1" href="product-detail.html">
                    ...
                    <div class="list-cart-item">
                        <a href="product-video.html#" class="image">
                            <img loading="lazy" width="212" height="283" src="assets/images/product/product-10.jpg"
                                alt="Image">
                        </a>
                        <div class="content">
                            <a class="name fw-medium link text-line-clamp-1" href="product-detail.html">
            ...
            <div class="wrap">
                <div class="tf-mini-cart-wrap list-file-delete wrap-empty_text">
                        ...
                        <div class="tf-mini-cart-sroll">
                            <div class="tf-mini-cart-items list-empty">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img loading="lazy" width="100" height="133"
                                            src="assets/images/product/product-3.jpg" alt="Image Product">
                                    </div>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img loading="lazy" width="100" height="133"
                                            src="assets/images/product/product-8.jpg" alt="Image Product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <a href="product-detail.html" class="name fw-medium link text-line-clamp-1">
                                            Oval shoulder bag
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img loading="lazy" width="100" height="133"
                                            src="assets/images/product/product-6.jpg" alt="Image Product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <a href="product-detail.html" class="name fw-medium link text-line-clamp-1">
                                            Square sunglasses
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img loading="lazy" width="100" height="133"
                                            src="assets/images/product/product-1.jpg" alt="Image Product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <a href="product-detail.html" class="name fw-medium link text-line-clamp-1">
                                            Lyocell wrap top
                    ...
                    <div class="tf-mini-cart-tool-openable add-note">
                        ...
                        <form action="product-video.html#" class="tf-mini-cart-tool-content">
                    ...
                    <div class="tf-mini-cart-tool-openable estimate-shipping">
                        ...
                        <form id="shipping-form" class="tf-mini-cart-tool-content">
                            ...
                            <div class="form-content gap-10">
                                ...
                                <div id="zipcode-message" class="error" style="display: none">We found one shipping
                                    rate
            ...
            <div class="modal-content">
                ...
                <div class="search-feature">
                    ...
                    <div class="tf-list-tag">
                        <a href="product-video.html#" class="link-tag">Dresses</a>
                        <a href="product-video.html#" class="link-tag">Dresses women</a>
                        <a href="product-video.html#" class="link-tag">Dresses midi</a>
                        <a href="product-video.html#" class="link-tag">Dress summer</a>
                    </div>
                </div>
                ...
                <div class="modal-main">
                    <form action="account-page.html" class="form-log">
                        ...
                        <div class="group-action">
                            ...
                            <a href="product-video.html#sign" data-bs-toggle="modal" class="tf-btn btn-stroke">
                                Login
                            </a>
                        </div>
                    </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-main">
                    <form action="account-page.html" class="form-log">
                        <div class="form-content">
                            <fieldset class="tf-field">
                                <label for="user-name-log" class="tf-lable fw-medium">Username or email address
                            ...
                            <fieldset class="field-bottom">
                                ...
                                <a href="product-video.html#modalForgot" data-bs-toggle="modal"
                        ...
                        <div class="group-action">
                            ...
                            <a href="product-video.html#register" data-bs-toggle="modal" class="tf-btn btn-stroke">
                                Create Account
                            </a>
                        </div>
                    </form>
